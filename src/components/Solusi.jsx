...
const Solusi = () => {
  return (
    <div
      className="solusiSection bg-[#F8FCFF] grid lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 grid-cols-1 lg:px-[100px] md:px-[50px] sm:px-[50px] px-[50px] h-full"
    
    >
      <div className="leftSolusi lg:mt-[100px] md:mt-[100px] sm:mt-[50px] mt-[50px]">
        <h3 className="lg:text-[40px] md:text-[38px] lg:text-left md:text-center sm:text-center text-center sm:text-[30px] text-[30px] font-semibold font-poppins" style={{wordSpacing: '0.1px'}}>
