...
const PacketWeb = () => {
  return (
    <div className=" lg:py-20 md:py-14 sm:py-16 py-16 px-12 flex flex-col justify-center lg:items-center md:items-center bg-[#F8FCFF]">
      <p style={{background: "linear-gradient(to right, #B9EFFF, #fff)"}} className="text-[#0597FA] text-center rounded-[4px] px-3 lg:text-[22px] md:text-[20px] sm:text-[16px] text-[16px] font-semibold">Berapa Harga Untuk Pembuatan Suatu Website?</p>
      ...
      <div className="grid lg:grid-cols-3 md:grid-cols-3 sm:grid-cols-3 grid-cols-1">
        <div className="data1 p-[30px] bg-[#fff] mb-5 lg:w-[350px] lg:me-10 md:me-0 sm:me-0 me-0 md:w-full sm:w-full w-full rounded-[12px]">
        ...
        <div className="data1 p-[30px] bg-[#0597FA] lg:w-[350px] md:w-full sm:w-full mb-5 w-full rounded-[12px]">
        ...
        <div className="data1 p-[30px] bg-[#fff] mb-5 lg:w-[350px] md:w-full sm:w-full w-full rounded-[12px]">
          <h3 className="text-[24px] font-semibold text-[#1e2022] mb-4">Lite</h3>
          <p className="text" style={{textDecoration: 'line-through'}}>Rp36.900</p>
          <p className="text-[25px] font-bold mb-3">Rp. 800.000</p>
